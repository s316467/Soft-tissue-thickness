...
close all
path2="hmr/landmark/";
% tissue ={"hmr_001.stl.mat", "hmr_002.stl.mat", "hmr_003.stl.mat", "hmr_004.stl.mat", "hmr_005.stl.mat", "hmr_006.stl.mat", "hmr_007.stl.mat", "hmr_008.stl.mat", "hmr_019.stl.mat", "hmr_027.stl.mat"}
tissue = {"hmr_001_landmark.mat"}
for i=1:1
    % 
    load(path2+tissue{i});
    % per soft tissue
    ...
    lm=table('Size',[28 4],'VariableTypes',{'string','double','double','double'});
        ...
        if exist('aldx','var')
           ...
           if exist('enr_soft','var')
            ...
            endocanthiondx = [enr_soft.Position(1) enr_soft.Position(2) enr_soft.Position(3)];
           ...
           if exist('enl_soft','var')
            ...
            endocanthionsx = [enl_soft.Position(1) enl_soft.Position(2) enl_soft.Position(3)];
            ...
            exocanthiondx = [exr_soft.Position(1) exr_soft.Position(2) exr_soft.Position(3)];
           ...
           if exist('exl_soft','var')
            ...
            exocanthionsx = [exl_soft.Position(1) exl_soft.Position(2) exl_soft.Position(3)];
           ...
           if exist('g_soft','var')
            ...
            glabella = [g_soft.Position(1) g_soft.Position(2) g_soft.Position(3)];
        ...
        if exist('li','var')
         ...
         if exist('ls','var')
           ...
           if exist('n_soft','var')
            ...
            nasion = [n_soft.Position(1) n_soft.Position(2) n_soft.Position(3)];
         ...
         if exist('orr_soft','var')
            ...
            orbitaledx = [orr_soft.Position(1) orr_soft.Position(2) orr_soft.Position(3)];
           ...
           if exist('orl_soft','var')
            ...
            orbitalesx = [orl_soft.Position(1) orl_soft.Position(2) orl_soft.Position(3)];
            ...
            orbitalesuperiusdx = [osr_soft.Position(1) osr_soft.Position(2) osr_soft.Position(3)];
           ...
           if exist('osl_soft','var')
            ...
            orbitalesuperiussx = [osl_soft.Position(1) osl_soft.Position(2) osl_soft.Position(3)];
         ...
         if exist('pg','var')
          ...
          if exist('se_soft','var')
            ...
            sellion = [se_soft.Position(1) se_soft.Position(2) se_soft.Position(3)];
           ...
           if exist('sl','var')
            ...
            zygiondx = [zyr_soft.Position(1) zyr_soft.Position(2) zyr_soft.Position(3)];
           ...
           if exist('zyl_soft','var')
            ...
            zygionsx = [zyl_soft.Position(1) zyl_soft.Position(2) zyl_soft.Position(3)];
          ...
          if exist('acl_soft','var')
            ...
            alar_curvature_sx = [acl_soft.Position(1) acl_soft.Position(2) acl_soft.Position(3)];
           ...
           if exist('acr_soft','var')
            ...
            alar_curvature_dx = [acr_soft.Position(1) acr_soft.Position(2) acr_soft.Position(3)];
        ...
        if exist('orl_hard','var')
         ...
         if exist('pog','var')
           ...
           if exist('zyl_hard','var')
            ...
            orbitalesuperiusdx_hard = [osr_hard.Position(1) osr_hard.Position(2) osr_hard.Position(3)];
            ...
            orbitalesuperiussx_hard = [osl_hard.Position(1) osl_hard.Position(2) osl_hard.Position(3)];
            ...
            glabella = [g_hard.Position(1) g_hard.Position(2) g_hard.Position(3)];
            ...
            alarcurvaturesx_hard = [acr_hard.Position(1) acr_hard.Position(2) acr_hard.Position(3)];
            ...
            endocanthiondx_hard = [enl_hard.Position(1) enl_hard.Position(2) enl_hard.Position(3)];
