...
%%%%% before cleaning 
ANOVA_landmark_before = ANOVA.analysis_ANOVA(all_data,all_genders,all_ages,landmark_names, 'before cleaning');
ANOVA_landmark_bmi_before = ANOVA.analysis_ANOVA_bmi(all_data_bmi, all_genders_bmi, all_ages_bmi, all_bmi, landmark_names, 'before cleaning');


%%% ANOVA analysis after cleaning
ANOVA_landmark_after = ANOVA.analysis_ANOVA(all_data_clean,all_genders,all_ages,landmark_names, 'after cleaning');
ANOVA_landmark_bmi_after = ANOVA.analysis_ANOVA_bmi(all_data_bmi_clean, all_genders_bmi, all_ages_bmi, all_bmi, landmark_names, 'after cleaning');
