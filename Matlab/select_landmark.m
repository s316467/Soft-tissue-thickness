...
%%% distances for men and women based on each age category 
plot_distances(men_u30,men_30_50, men_o50, women_u30, women_30_50,women_o50, landmark_names);

%%% ANOVA analysis
ANOVA_landmark = analysis_ANOVA(all_data,all_genders,all_ages,landmark_names);
...
[top_3_rf_age,top_3_rf_sex,top_3_rf,top_3_dt_age,top_3_dt_sex,top_3_dt,model_age,model_sex,model_ga] =analysis_RF_DT(landmark_names, all_data, all_genders, all_ages);
