...
%%%%% before cleaning 
ANCOVA_landmark_before = ANCOVA.analysis_ANCOVA(all_data,all_genders,all_ages,landmark_names, 'before cleaning');
ANCOVA_landmark_bmi_before = ANCOVA.analysis_ANCOVA_bmi(all_data_bmi, all_genders_bmi, all_ages_bmi, all_bmi, landmark_names, 'before cleaning');


%%% ANOVA analysis after cleaning
ANCOVA_landmark_after = ANCOVA.analysis_ANCOVA(all_data_clean,all_genders,all_ages,landmark_names, 'after cleaning');
ANCOVA_landmark_bmi_after = ANCOVA.analysis_ANCOVA_bmi(all_data_bmi_clean, all_genders_bmi, all_ages_bmi, all_bmi, landmark_names, 'after cleaning');
